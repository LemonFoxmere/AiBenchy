...
model.add(Dense(800, activation='selu')) # these layers don't do much because of the vanishing gradient. It just makes the computation longer and more torturous.
model.add(Dense(500, activation='selu')) # the reason for such small amount of nodes is that the back may generate lots of noise from the vanishing gradient, interferring with the
model.add(Dense(500, activation='selu')) # next layer.
